...
import liucheuski.siarhei.servlets.repository.dbconstants.PersonTableConstants;
...
public class SQLHelper {
    ...
    public final static String SQL_CHECK_LOGIN = "SELECT " + UserTableConstants.LOGIN.getFieldName() + " FROM " + USER_TABLE + " WHERE " +
